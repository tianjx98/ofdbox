    ...
    public static void scanFontDir(File fontDir) {
        ...
        for (File file : fontDir.listFiles()) {
                ...
                try {
                    ...
                    trueTypeCollection.processAllFonts(new TrueTypeCollection.TrueTypeFontProcessor() {
                        ...
                        public void process(TrueTypeFont trueTypeFont) throws IOException {
                            ...
                            log.info(String.format("加载字体 %s,%s,%s", namingTable.getFontFamily(),
                                            namingTable.getPostScriptName(), file.getAbsoluteFile()));

                            addSystemFontMapping(namingTable.getFontFamily(), namingTable.getPostScriptName(),
            ...
            try {
                ...
                log.info(String.format("加载字体 %s,%s,%s", namingTable.getFontFamily(), namingTable.getPostScriptName(),
